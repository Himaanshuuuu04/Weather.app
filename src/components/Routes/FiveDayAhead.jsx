...
export default function FiveDayAhead() {
    ...
    <div>
      <div className="temp-container">
        <div className="temp-box">
          <h1 className="temperature">
            {weatherData
              ? parseInt(
                  (weatherData.daily.temperature_2m_min[4] +
          ...
          <div>
            <h4 className="minTemparature">
              {weatherData
                ? parseInt(weatherData.daily.temperature_2m_min[4]) + "°C"
                : "NA"}
            </h4>
            <h4 className="maxTemperature">
              {weatherData
                ? parseInt(weatherData.daily.temperature_2m_max[4]) + "°C"
                : "NA"}
            </h4>
          </div>
        </div>
        <Description
          heading={weatherData ? weatherData.daily.weather_code[4] : 0}
          description={weatherData ? weatherData.daily.weather_code[4] : 0}
        />
      ...
      <div className="uv-container">
        <div className="temp-box" id="uvindex">
          <h1 className="temperature">
            {weatherData ? weatherData.daily.uv_index_max[4] : "NA"}
          </h1>
          <div>
        ...
        <TemperatureChart
          temp={
            weatherData
              ? weatherData.hourly.temperature_2m.slice(96, 120)
              : "NA"
          }
        />
      </div>
