...
export default function FourDayAhead() {
    ...
    <div>
        ...
        <div className="temp-box">
          ...
          <div>
            <h4 className="minTemparature">
              {weatherData
                ? parseInt(weatherData.daily.temperature_2m_min[3]) + "°C"
                : "NA"}
            </h4>
            <h4 className="maxTemperature">
              {weatherData
                ? parseInt(weatherData.daily.temperature_2m_max[3]) + "°C"
                : "NA"}
            </h4>
          </div>
        </div>
        <Description
          heading={weatherData ? weatherData.daily.weather_code[3] : 0}
          description={weatherData ? weatherData.daily.weather_code[3] : 0}
        />
      ...
      <div className="uv-container">
        <div className="temp-box" id="uvindex">
          <h1 className="temperature">
            {weatherData ? weatherData.daily.uv_index_max[3] : "NA"}
          </h1>
          <div>
        ...
        <TemperatureChart
          temp={
            weatherData ? weatherData.hourly.temperature_2m.slice(72, 96) : "NA"
          }
        />
      </div>
    </div>
